...
This repository is a **type-C fork** of [`https://gitlab.redox-os.org/redox-os/orbdata.git`](https://gitlab.redox-os.org/redox-os/orbdata.git) carrying E-OS changes. The full
